 ...
 */
public class SampleCard3 implements CardProxy.ICardProxyPresenter{


    private final Context mContext;
    public SampleCard3(Context context) {
        mContext = context;
    }
    ...
    public Constant.CardContract.CardType getCardType() {
        return Constant.CardContract.CardType.BIG_CARD;
    }
